...
class UserSkill(models.Model):
    ...
    user=models.ForeignKey("SkillConnect.CustomUser",on_delete=models.CASCADE,related_name="user_skills")
...
class WorkOffers(models.Model):
    offered_by=models.ForeignKey("SkillConnect.CustomUser",on_delete=models.CASCADE,related_name="user_offers")
    description=models.TextField()
...
class WorkRequests(models.Model):
    ...
    requested_by=models.ForeignKey("SkillConnect.CustomUser",on_delete=models.CASCADE)
    name=models.CharField(max_length=300)
    description=models.TextField()
...
class WorkMatches(models.Model):
    ...
    def __str__(self):
        return f"{self.offered.offered_by.username} ({self.get_status_display()})"                                    